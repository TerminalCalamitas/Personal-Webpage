export const h2Style =
  "text-3xl font-bold mb-8 bg-gradient-to-r from-coral-red-500 to-coral-red-600 bg-clip-text text-transparent text-center";
export const h3Style = "text-xl font-bold mb-4";
export const h4Style = "font-semibold";
